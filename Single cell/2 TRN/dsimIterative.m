...
Summed_Isyn1 = Esyn1 + Isyn1 + sim.gj21*(v1-v2);
...
ds(31)=dh_ca_lts2;
ds(32)=dm_ar2;
Ina2 = (sim.g_nat*(s(22)^3)*s(23) + sim.g_nap*s(24))*(v2 -50);
Ik2 =  (sim.g_kd*(s(25)^4) + sim.g_kt*(s(26)^4)*s(27) + sim.g_k2*s(28)*s(29))*(v2 +100);
ICa2 = (sim.g_ca_lts*(s(30)^2)*s(31))*(v2 -125);
...
Summed_Isyn2 = Esyn2 + Isyn2 + sim.gj12*(v2-v1);

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% final equations

ds(1)  = (-1/sim.C)*(Ina1 + Ik1 + ICa1 + IAR1 + IL1 + ix1 + Summed_Isyn1);
ds(21) = (-1/sim.C)*(Ina2 + Ik2 + ICa2 + IAR2 + IL2 + ix2 + Summed_Isyn2);
